...
- This package owns `Models\{Plan,Subscription}`, `Enums\{PeriodUnit,SubscriptionStatus}`, `Exceptions\{PlanInUseException,SubscriptionPaymentException}`, `Database\Seeders\PlanSeeder`, and `SubscriptionServiceProvider`. Depend only on `misaf/vendra-support` (for `ShouldLogActivity`) and framework/Spatie packages — never on a domain provider such as `misaf/vendra-tenant`, `misaf/vendra-user`, or `misaf/vendra-permission`.
